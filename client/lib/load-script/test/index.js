...
describe( 'loadScript', function() {
	...
	// TODO: Figure out how to enable tests that rely on the DOM API.
	...
	// 		expect( script.tagName ).to.eql( 'SCRIPT' );
	// 	} );
	//
	...
	//
	// 	const url = '/';
	// 	const id = 'testing-attach-to-head';
	// 	const element = _createScriptElement( url );
	// 	element.id = id;
	//
	// 	it( 'should attach the element to the document head', function() {
	// 		_attachToHead( element );
	// 		const selectedElement = document.getElementById( id );
	// 		expect( selectedElement ).to.eql( element );
	// 	} );
	// } );
	// END TODO

	describe( '_loadScript( url, callback, attachToHead, createScriptElement )', function() {
		const url = '/';
